	...
	theme: {
		...
		extend: {
			...
			animation: {
				...
				'fade-in-delay-1': 'fade-in 0.7s cubic-bezier(0.16, 1, 0.3, 1) 0.1s forwards',
				'fade-in-delay-2': 'fade-in 0.7s cubic-bezier(0.16, 1, 0.3, 1) 0.2s forwards',
				'fade-in-delay-3': 'fade-in 0.7s cubic-bezier(0.16, 1, 0.3, 1) 0.3s forwards',
